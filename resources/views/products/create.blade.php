    ...
    <form method="POST" action="{{ route('products.store') }}">
        ...
        <div class="cp-create-row">
            ...
            <div class="cp-control">
                <input type="text" name="product_name" value="{{ old('product_name') }}" class="cp-input">
                @error('product_name')
        ...
        <div class="cp-create-row">
            ...
            <div class="cp-control">
                <input type="number" name="product_price" value="{{ old('product_price') }}" class="cp-input">
                @error('product_price')
                    <div class="text-red-500 text-sm">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="cp-create-row">
            ...
            <div class="cp-control">
                <textarea name="description" class="cp-input">{{ old('description') }}</textarea>
                @error('description')
                    <div class="text-red-500 text-sm">{{ $message }}</div>
                @enderror
            </div>
